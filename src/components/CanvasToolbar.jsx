        ...
        {expanded && (
          <div className="bg-white border-l shadow-lg p-3 rounded-l-md flex flex-col items-center space-y-3 min-w-[90px]">
            ...
            <div className="flex flex-col items-center space-y-1">
              <span className="text-[10px] text-gray-400 uppercase tracking-wide">BG</span>
              <input
                type="color"
              ...
              />
              <label className="cursor-pointer text-gray-500 hover:text-blue-600 transition" title="Upload Background Image">
                <FiImage size={16} />
              ...
              <button
                ...
                className="text-[9px] text-gray-500 hover:text-blue-600 underline transition"
                title="Reset this slide to default green"
              >
                Default Slide
              </button>
              <button
                ...
                className="text-[9px] text-gray-500 hover:text-blue-600 underline transition"
                title="Reset all slides to default green"
              >
                Default All
              </button>
            </div>
            ...
            {/* ── Text editing controls (only when lines selected) ── */}
            {hasSelection && (
              <>
                {/* Text Color */}
                <div className="flex flex-col items-center space-y-1">
                  <span className="text-[10px] text-gray-400 uppercase tracking-wide">Text</span>
                  <input
                    type="color"
