    ...
    >
        ...
        {canvasLines.map((line, idx) =>
          line.type === "image" ? (
            ...
            <div
              ...
              onClick={() => {
                if (editMode === "line") setSelectedIds([line.id]);
              ...
              className={`absolute ${selectedIds.includes(line.id) ? "border border-yellow-300" : ""}`}
              style={{
                left:      `${line.x}px`,
                top:       `${line.y}px`,
                width:     `${line.width}px`,
            ...
            <div
              ...
              className={`absolute font-bold px-2 ${
              ...
              style={{
                ...
                ...(line.outlineColor ? {
                  WebkitTextStroke: `${line.outlineSize || 1.5}px ${line.outlineColor}`,
      ...
      <CanvasToolbar
        ...
        onBackgroundChange={(bg) => {
          const { _scope, ...props } = bg;
          if (props.backgroundTheme !== undefined && _scope === "all") {
            setAllSlidesBackground(props);
          } else {
            setSlideBackground(currentIndex, props);
          }
